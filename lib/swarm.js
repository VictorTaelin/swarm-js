...
var downloadData = function downloadData(swarmUrl) {
  return function (hash) {
    return got(rawUrl(swarmUrl)(hash), { encoding: null }).then(function (response) {
...
var uploadData = function uploadData(swarmUrl) {
  return function (data) {
    return got(swarmUrl + "/bzzr:/", { "body": data, "retries": 2 }).then(function (response) {
      return response.body;
    });
  };
};
      ...
      return function (file) {
        var attempt = function attempt(n) {
          ...
          var opt = {
            ...
            "body": file.data };
          return got.put(url, opt).then(function (response) {
            return response.body;
          }).catch(function (e) {
